function [virtualMachinesInServer, valueVMs] = createNewVirtualMachinesFuc(tasksInterval, taskIndex, serverIndex, vCPUs_server, GPUs_server, periodTasks, totalLoadCpus, ...
